...
namespace AbstractOperation{
    AbstractOperation::AbstractOperation(const std::string& operation, const std::string& inPutFiles, const std::string& outPutFile, CacheManager::CacheManager& cacheManager)
